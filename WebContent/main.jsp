			...
			<div style="position: relative;">
				...
				<table style="position: absolute; left: 75%; top: 15px;">
					<tr>
						...
						<td style="width: 120px"><a href="${pageContext.request.contextPath}/QuitLoginServlet"
...
<script>
	...
	$(function() {//jq的页面加载完成事件
		...
		$("#selectuser").click(function() {
		    var url = "${pageContext.request.contextPath}/FindAllServlet";
			$.get(url,function () {
                addTab("#usertab", "用户查询", "icon-zoom", "selectuser.jsp");
            });
		});
        $("#selectJob").click(function() {
            var url = "${pageContext.request.contextPath}/FindAllJobServlet";
            $.get(url,function () {
                addTab("#usertab", "职位查询", "icon-zoom", "selectJob.jsp");
            });
		});
        $("#selectEmp").click(function() {
            var url = "${pageContext.request.contextPath}/FinAllEmpServlet";
            $.get(url,function () {
